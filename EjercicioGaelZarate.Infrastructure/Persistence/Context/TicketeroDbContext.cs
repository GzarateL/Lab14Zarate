...
namespace EjercicioGaelZarate.Infrastructure.Persistence.Context;

public partial class TicketeroDbContext : DbContext
{
    public TicketeroDbContext(DbContextOptions<TicketeroDbContext> options)
        : base(options)
    {
    }
