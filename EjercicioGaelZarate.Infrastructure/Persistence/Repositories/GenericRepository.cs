...
namespace EjercicioGaelZarate.Infrastructure.Persistence.Repositories
{
    ...
    {
        protected readonly TicketeroDbContext _context;

        public GenericRepository(TicketeroDbContext context)
        {
            _context = context;
        }

        public async Task<T> GetByIdAsync(Guid id) // Corregido a Guid
        {
